...
class SequenceModule(SequenceFields, ProctoringFields, XModule):
    ...
    def gate_entire_sequence_if_it_is_a_timed_exam_and_contains_content_type_gated_problems(self):
        ...
        """
        self.gated_sequence_paywall = None
        content_type_gating_paywall = self._check_children_for_content_type_gating_paywall(self)
        if content_type_gating_paywall:
            self.gated_sequence_paywall = content_type_gating_paywall
